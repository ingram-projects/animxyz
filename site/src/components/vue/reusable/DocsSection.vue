  ...
  <div class="docs-section__wrap" :id="section.id">
    <article class="docs-section">
      <header class="section-header">
        ...
        <a
          class="section-examples-button"
          v-if="section.examples && section.examples.length"
          :href="`?tab=examples#${section.id}`"
          >Examples</a
        >
      </header>
...
<script>
import MarkdownContent from '~/components/vue/reusable/MarkdownContent.vue'
