...
const app = createApp({
	...
	template: `
		<main>
			...
			<section id="appear">
				<XyzTransition appear data-xyz="fade" @after-appear="logEvent('appear:after-appear')">
			...
			<section id="duration">
				...
				<XyzTransition data-xyz="fade" :duration="50" @after-enter="logEvent('duration-number:after-enter')">
				...
				<XyzTransition data-xyz="fade" duration="auto" @after-enter="logEvent('duration-auto:after-enter')">
			...
			<section id="group-section">
				...
				<XyzTransitionGroup id="group" tag="ul" data-xyz="fade" class="group-class">
			...
			<section id="directive">
				...
				<div id="dir-compose" class="box" data-xyz="duration-5" v-xyz="dirValue"></div>
