...
In addition, AnimXYZ provides wrapper components for the [Vue](https://vuejs.org/v2/guide/transitions.html) and [React](https://reactcommunity.org/react-transition-group/) transition components, making them smarter and easier to use.
