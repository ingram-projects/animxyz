...
examples:
  ...
  - name: Staggered
    template: |
      <xyz-transition-group tag="div" class="square-group" xyz="fade small stagger-5" :duration="3500" v-on="data.listeners">
    ...
    code:
      - language: html
        content: |
          <div class="square-group" xyz="fade small stagger-5">
